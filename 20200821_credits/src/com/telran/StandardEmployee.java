...
public class StandardEmployee extends Thread {
    ...
    public StandardEmployee(int fastestDecisionTime, int longestDecisionTime
            , String name, int creditNumber, List<Result> resultList) {
        this.shortestDecisionTime = fastestDecisionTime;
