...
class SegmentsAndPointsTest {
    ...
    public void testGetNumCover_emptyPointsEmptySegments_emptyList() {
        ...
        assertEquals(expected, segmentsAndPoints.getNumCover(points, segments));
    }
    ...
    public void testGetNumCover_anyPointsAnySegments_anyList() {
        ...
        List<Segment> segments = Arrays.asList(new Segment(0, 2), new Segment(4, 5));
